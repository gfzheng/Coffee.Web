  ...
  <div class="tab">
    ...
    <el-tabs tab-position="left" v-model="activeName" @tab-click="handleClick">
      <el-tab-pane name="text">
        <span slot="label">
          <i class="fa fa-commenting-o fa-fw"></i> 文字</span>
        <tab-text/>
      </el-tab-pane>
      ...
      <el-tab-pane name="movie">
        <span slot="label">
          <i class="fa fa-film fa-fw"></i> 电影</span>
        <el-card class="tab-card" shadow="hover">
          Coming soon...
        </el-card>
        </el-pagination>
      ...
      <el-tab-pane name="app">
        <span slot="label">
          <i class="fa fa-cubes fa-fw"></i> 应用</span>
        <el-card class="tab-card" shadow="hover">
          Coming soon...
        </el-card>
        </el-pagination>
      ...
      <el-tab-pane name="game">
        <span slot="label">
          <i class="fa fa-gamepad fa-fw"></i> 游戏</span>
        <el-card class="tab-card" shadow="hover">
          Coming soon...
        </el-card>
        </el-pagination>
      ...
      <el-tab-pane name="doc">
        <span slot="label">
          <i class="fa fa-file-text-o fa-fw"></i> 文档</span>
        <el-card class="tab-card" shadow="hover">
          Coming soon...
        </el-card>
      </el-tab-pane>
...
import tabImage from './Content/Image/Image'
export default {
  name: "Tab",
  components: {
    tabText, TopButton, tabImage
  },
  computed: {},
  data () {
    return {
