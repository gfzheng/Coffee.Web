<template>
  <div class="img-uploader" @drop="handleDrop" ref="uploader">
    ...
    <!-- input-->
    <input style="display: none" :id="inputId" ref="input" type="file" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" multiple="multiple" @change="handleFileChange" />
